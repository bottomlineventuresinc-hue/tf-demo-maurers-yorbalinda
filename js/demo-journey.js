/* Template Factory - Maurers live demo journey.
...
(function () {
  ...
  var LIVE_URL = 'https://bottomlineventuresinc-hue.github.io/tf-demo-maurers-yorbalinda/';
  var LS_CHANGES = 'tf_maurers_change_log_v1';
  var LS_PURCHASED = 'tf_maurers_purchased_v1';
  ...
  function setBarMode(mode) {
    ...
    if (!barSub) return;
    if (mode === 'updated') {
      barSub.textContent = 'Draft for Dennis at Maurers. Claim it, preview the rest of the journey, or request a change.';
    } else {
      barSub.textContent = 'Draft for Dennis at Maurers. Claim it, preview the rest of the journey, or request a change.';
    }
  }
  ...
  if (changeForm) {
    changeForm.addEventListener('submit', function (e) {
      ...
      runSpinner(
        ...
        'Updating the draft for Maurers. Hang tight.',
        delay,
        function () {
